...
* Add spy infrastructure and make sure it can be compiled away in production.
...
* Add ability to specify initial entityCapacity when creating world to avoid re-allocating arrays multiple times
