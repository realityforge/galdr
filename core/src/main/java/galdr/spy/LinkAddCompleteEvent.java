...
/**
 * Notification emitted after a link is created.
 */
public final class LinkAddCompleteEvent
  implements SerializableEvent
{
  ...
  public LinkAddCompleteEvent( @Nonnull final World world, final int sourceEntityId, final int targetEntityId )
  {
