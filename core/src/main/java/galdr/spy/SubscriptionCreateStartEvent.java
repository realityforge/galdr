...
/**
 * Notification emitted before a subscription is created.
 */
public final class SubscriptionCreateStartEvent
  implements SerializableEvent
{
  ...
  public SubscriptionCreateStartEvent( final int id,
  ...
  {
    map.put( "type", "SubscriptionCreateStart" );
    map.put( "id", _id );
    map.put( "name", _name );
