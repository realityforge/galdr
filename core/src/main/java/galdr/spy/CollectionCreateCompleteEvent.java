 ...
 */
public final class CollectionCreateCompleteEvent
  implements SerializableEvent
{
  ...
  public CollectionCreateCompleteEvent( @Nonnull final CollectionInfo collection )
  {
  ...
  {
    map.put( "type", "CollectionCreateComplete" );
