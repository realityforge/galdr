...
public class CollectionCreateStartEventTest
  extends AbstractTest
{
  ...
  public void basicOperation()
  {
    ...
    final CollectionCreateStartEvent event = new CollectionCreateStartEvent( info );
    ...
    assertEquals( data.get( "type" ), "CollectionCreateStart" );
