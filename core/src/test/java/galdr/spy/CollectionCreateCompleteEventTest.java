...
public class CollectionCreateCompleteEventTest
  extends AbstractTest
{
  ...
  public void basicOperation()
  {
    ...
    final CollectionCreateCompleteEvent event = new CollectionCreateCompleteEvent( info );
    ...
    assertEquals( data.get( "type" ), "CollectionCreateComplete" );
