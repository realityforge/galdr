...
public class SubscriptionCreateStartEventTest
  extends AbstractTest
{
  ...
  public void basicOperation()
  {
    ...
    final SubscriptionCreateStartEvent event =
      new SubscriptionCreateStartEvent( id, name, areaOfInterest );
    ...
    assertEquals( data.get( "type" ), "SubscriptionCreateStart" );
