...
public class ComponentWillRemoveEventTest
  extends AbstractTest
{
  ...
  public void basicOperation()
  {
    ...
    final ComponentWillRemoveEvent event = new ComponentWillRemoveEvent( world, entityId, componentId );
    ...
    assertEquals( data.get( "type" ), "ComponentWillRemove" );
