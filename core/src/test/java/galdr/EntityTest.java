  ...
  extends AbstractTest
{
  ...
  public void unlinkIncoming_noMatchingLink()
  {
    ...
    final Link link1 = run( world, () -> em.link( entity1, entity2, false, false ) );
    run( world, () -> em.link( entity1, entity3, false, false ) );
  ...
  public void unlinkOutgoing_noMatchingLink()
  {
    ...
    final Link link1 = run( world, () -> em.link( entity1, entity2, false, false ) );
    run( world, () -> em.link( entity3, entity2, false, false ) );
