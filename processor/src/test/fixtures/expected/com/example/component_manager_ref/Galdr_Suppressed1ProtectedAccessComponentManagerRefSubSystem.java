...
public final class Galdr_Suppressed1ProtectedAccessComponentManagerRefSubSystem implements PostConstructFn, ProcessorFn {
  @Nonnull
  ...
  private static final class EnhancedSubSystem extends Suppressed1ProtectedAccessComponentManagerRefSubSystem {
    ...
    @Override
    @Nonnull
    protected final ComponentManager<Suppressed1ProtectedAccessComponentManagerRefSubSystem.MyComponent> cm(
        ) {
