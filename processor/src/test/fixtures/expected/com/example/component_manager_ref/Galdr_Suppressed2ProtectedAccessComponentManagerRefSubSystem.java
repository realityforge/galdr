...
public final class Galdr_Suppressed2ProtectedAccessComponentManagerRefSubSystem implements PostConstructFn, ProcessorFn {
  @Nonnull
  ...
  private static final class EnhancedSubSystem extends Suppressed2ProtectedAccessComponentManagerRefSubSystem {
    ...
    @Override
    @Nonnull
    protected final ComponentManager<Suppressed2ProtectedAccessComponentManagerRefSubSystem.MyComponent> cm(
        ) {
