...
public final class Galdr_MultiSameComponentManagerRefSubSystem implements PostConstructFn, SubSystem {
  @Nonnull
  ...
  private static final class EnhancedSubSystem extends MultiSameComponentManagerRefSubSystem {
    ...
    @Override
    @Nonnull
    final ComponentManager<MultiSameComponentManagerRefSubSystem.MyComponent1> cm1() {
    ...
    @Override
    @Nonnull
    final ComponentManager<MultiSameComponentManagerRefSubSystem.MyComponent1> cm2() {
