...
public final class Galdr_Suppressed1ProtectedAccessEntityProcessorSubSystem implements PostConstructFn, OnActivateFn, OnDeactivateFn, ProcessorFn {
  @Nonnull
  ...
  private static final class EnhancedSubSystem extends Suppressed1ProtectedAccessEntityProcessorSubSystem {
    @Nonnull
    private final Galdr_Suppressed1ProtectedAccessEntityProcessorSubSystem $galdr$_outer;
    ...
    private EnhancedSubSystem(
        @Nonnull final Galdr_Suppressed1ProtectedAccessEntityProcessorSubSystem outer) {
      $galdr$_outer = Objects.requireNonNull( outer );
    }

    private void $galdr$_postConstruct() {
      $galdraoi$_process = $galdr$_outer.$galdr$_getWorld().createAreaOfInterest( Collections.singleton( Suppressed1ProtectedAccessEntityProcessorSubSystem.MyComponent.class ) );
    }
    ...
    private String $galdr$_getName() {
      return "Suppressed1ProtectedAccessEntityProcessorSubSystem";
    }
