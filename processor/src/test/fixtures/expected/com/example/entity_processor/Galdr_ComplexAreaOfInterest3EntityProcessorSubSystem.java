...
public final class Galdr_ComplexAreaOfInterest3EntityProcessorSubSystem implements PostConstructFn, OnActivateFn, OnDeactivateFn, ProcessorFn {
  @Nonnull
  ...
  private static final class EnhancedSubSystem extends ComplexAreaOfInterest3EntityProcessorSubSystem {
    @Nonnull
    private final Galdr_ComplexAreaOfInterest3EntityProcessorSubSystem $galdr$_outer;
    ...
    private EnhancedSubSystem(
        @Nonnull final Galdr_ComplexAreaOfInterest3EntityProcessorSubSystem outer) {
      $galdr$_outer = Objects.requireNonNull( outer );
    }

    private void $galdr$_postConstruct() {
      $galdraoi$_process = $galdr$_outer.$galdr$_getWorld().createAreaOfInterest( Collections.singleton( ComplexAreaOfInterest3EntityProcessorSubSystem.MyComponent1.class ), Collections.emptyList(), Arrays.asList( ComplexAreaOfInterest3EntityProcessorSubSystem.MyComponent2.class,ComplexAreaOfInterest3EntityProcessorSubSystem.MyComponent3.class ) );
    }
    ...
    private String $galdr$_getName() {
      return "ComplexAreaOfInterest3EntityProcessorSubSystem";
    }
