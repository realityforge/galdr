...
import com.example.entity_processor.other.BaseProtectedAccessEntityProcessorSubSystem;
...
public final class Galdr_ProtectedAccessFromBaseEntityProcessorSubSystem implements PostConstructFn, OnActivateFn, OnDeactivateFn, ProcessorFn {
  @Nonnull
  ...
  private static final class EnhancedSubSystem extends ProtectedAccessFromBaseEntityProcessorSubSystem {
    @Nonnull
    private final Galdr_ProtectedAccessFromBaseEntityProcessorSubSystem $galdr$_outer;
    ...
    private EnhancedSubSystem(
        @Nonnull final Galdr_ProtectedAccessFromBaseEntityProcessorSubSystem outer) {
      $galdr$_outer = Objects.requireNonNull( outer );
    }

    private void $galdr$_postConstruct() {
      $galdraoi$_process = $galdr$_outer.$galdr$_getWorld().createAreaOfInterest( Collections.singleton( BaseProtectedAccessEntityProcessorSubSystem.MyComponent.class ) );
    }
    ...
    private String $galdr$_getName() {
      return "ProtectedAccessFromBaseEntityProcessorSubSystem";
    }
