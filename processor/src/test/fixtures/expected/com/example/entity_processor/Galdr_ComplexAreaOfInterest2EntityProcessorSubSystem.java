...
public final class Galdr_ComplexAreaOfInterest2EntityProcessorSubSystem implements PostConstructFn, OnActivateFn, OnDeactivateFn, ProcessorFn {
  @Nonnull
  ...
  private static final class EnhancedSubSystem extends ComplexAreaOfInterest2EntityProcessorSubSystem {
    @Nonnull
    private final Galdr_ComplexAreaOfInterest2EntityProcessorSubSystem $galdr$_outer;
    ...
    private EnhancedSubSystem(
        @Nonnull final Galdr_ComplexAreaOfInterest2EntityProcessorSubSystem outer) {
      $galdr$_outer = Objects.requireNonNull( outer );
    }

    private void $galdr$_postConstruct() {
      $galdraoi$_process = $galdr$_outer.$galdr$_getWorld().createAreaOfInterest( Collections.singleton( ComplexAreaOfInterest2EntityProcessorSubSystem.MyComponent1.class ), Arrays.asList( ComplexAreaOfInterest2EntityProcessorSubSystem.MyComponent2.class,ComplexAreaOfInterest2EntityProcessorSubSystem.MyComponent3.class ) );
    }
    ...
    private String $galdr$_getName() {
      return "ComplexAreaOfInterest2EntityProcessorSubSystem";
    }
