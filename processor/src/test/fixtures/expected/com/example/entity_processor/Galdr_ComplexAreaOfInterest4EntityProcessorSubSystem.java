...
public final class Galdr_ComplexAreaOfInterest4EntityProcessorSubSystem implements PostConstructFn, OnActivateFn, OnDeactivateFn, ProcessorFn {
  @Nonnull
  ...
  private static final class EnhancedSubSystem extends ComplexAreaOfInterest4EntityProcessorSubSystem {
    @Nonnull
    private final Galdr_ComplexAreaOfInterest4EntityProcessorSubSystem $galdr$_outer;
    ...
    private EnhancedSubSystem(
        @Nonnull final Galdr_ComplexAreaOfInterest4EntityProcessorSubSystem outer) {
      $galdr$_outer = Objects.requireNonNull( outer );
    }

    private void $galdr$_postConstruct() {
      $galdraoi$_process = $galdr$_outer.$galdr$_getWorld().createAreaOfInterest( Collections.emptyList(), Arrays.asList( ComplexAreaOfInterest4EntityProcessorSubSystem.MyComponent2.class,ComplexAreaOfInterest4EntityProcessorSubSystem.MyComponent3.class ), Collections.singleton( ComplexAreaOfInterest4EntityProcessorSubSystem.MyComponent1.class ) );
    }
    ...
    private String $galdr$_getName() {
      return "ComplexAreaOfInterest4EntityProcessorSubSystem";
    }
