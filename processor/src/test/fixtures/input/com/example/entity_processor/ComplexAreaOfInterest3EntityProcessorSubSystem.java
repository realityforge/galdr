...
@SubSystem
public abstract class ComplexAreaOfInterest3EntityProcessorSubSystem
{
  ...
  @EntityProcessor( all = MyComponent1.class, exclude = { MyComponent2.class, MyComponent3.class } )
