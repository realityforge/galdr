...
public final class Galdr_BasicComponentManagerRefSubSystem implements PostConstructFn, SubSystem {
  @Nonnull
  ...
  private static final class EnhancedSubSystem extends BasicComponentManagerRefSubSystem {
    ...
    @Override
    @Nonnull
    final ComponentManager<BasicComponentManagerRefSubSystem.MyComponent> cm() {
