...
public final class Galdr_BasicEntityProcessorSubSystem implements PostConstructFn, OnActivateFn, OnDeactivateFn, SubSystem {
  ...
  private static final class EnhancedSubSystem extends BasicEntityProcessorSubSystem {
    @Nonnull
    private final Galdr_BasicEntityProcessorSubSystem $galdr$_outer;
    ...
    private EnhancedSubSystem(@Nonnull final Galdr_BasicEntityProcessorSubSystem outer) {
      $galdr$_outer = Objects.requireNonNull( outer );
    }

    private void $galdr$_postConstruct() {
      $galdraoi$_process = $galdr$_outer.$galdr$_getWorld().createAreaOfInterest( Collections.singleton( BasicEntityProcessorSubSystem.MyComponent.class ) );
    }
    ...
    private String $galdr$_getName() {
      return "BasicEntityProcessorSubSystem";
    }
